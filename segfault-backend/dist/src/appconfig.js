export const FRONTEND_URL = process.env.FRONTEND_URL ?? 'https://segfault-frontend.politeriver-a25e3b65.westeurope.azurecontainerapps.io';
export const GOOGLE_OAUTH = {
    ...
    REDIRECT_URI: process.env.GOOGLE_REDIRECT_URI ?? 'https://segfault-backend.politeriver-a25e3b65.westeurope.azurecontainerapps.io/auth/callback',
};
export const JWT = {
