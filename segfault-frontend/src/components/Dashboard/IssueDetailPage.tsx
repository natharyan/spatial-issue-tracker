...
interface IssueDetailPageProps {
    ...
    onClose: () => void;
    issueId: string | null;
    onFindOnMap?: (lat: number, lng: number) => void;
}

const IssueDetailPage = ({ open, onClose, issueId, onFindOnMap }: IssueDetailPageProps) => {
            ...
            <Box sx={{ p: 3, overflowY: 'auto', flex: 1 }}>
                {loading ? (
                    ...
                    <>
                        ...
                        {/* Find on Map Button */}
                        {onFindOnMap && issue.lat !== undefined && issue.lng !== undefined && (
                            <Button
                                variant="outlined"
                                startIcon={<MapIcon />}
                                onClick={() => onFindOnMap(issue.lat!, issue.lng!)}
                                sx={{ mb: 3 }}
                                fullWidth
                            >
                                Find on Map
